...
if($i=="1"){
	...
	$team['team_2_goals']	= ($goals[$bothteams['@attributes']['ID']]['name'])?$goals[$bothteams['@attributes']['ID']]['name']:"";
	...
	$team['team_1_goals']	= ($goals[$bothteams['@attributes']['ID']]['name'])?$goals[$bothteams['@attributes']['ID']]['name']:"";
