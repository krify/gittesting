...
public class HorizontalPager extends ViewGroup {
    ...
    public HorizontalPager(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.com_marketplace_views_HorizontalPager);
        pageWidthSpec = a.getDimensionPixelSize(R.styleable.com_marketplace_views_HorizontalPager_pageWidth, SPEC_UNDEFINED);
        a.recycle();
