...
public class PlacedTodayAdsAdapter extends SimpleAdapter{
	 ...
	 List<HashMap<String, Object>> map;
	   ...
	   // ImageDownloder2xsize imagedownloader;
	    ...
	    public PlacedTodayAdsAdapter(Activity activity, List<HashMap<String, Object>> data,
	    ...
	    @Override
		 public View getView(int position, View convertView, ViewGroup parent) {
	    	...
	    	if(convertView==null){
	        	...
	        	holder.Product_id1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_product_id_tv);
	        	holder.Product_title1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_item_product_title_tv);
	        	holder.Product_location1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_product_location_tv);
	        	holder.Product_currency1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_product_currency_tv);
	        	holder.Product_price1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_product_price_tv);
	        	holder.Product_image1 = (ImageView) convertView.findViewById(R.id.browse_ads_individual_add_product_image_iv);
	        	holder.Product_phone1 = (TextView) convertView.findViewById(R.id.browse_ads_individual_add_product_phone_tv);
